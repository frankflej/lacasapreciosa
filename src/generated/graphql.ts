...
export const FetchingTestingDocument = `
...
export const useFetchingTestingQuery = <
      TData = FetchingTestingQuery,
      TError = unknown
    >(
      variables?: FetchingTestingQueryVariables,
      options?: Omit<UseQueryOptions<FetchingTestingQuery, TError, TData>, 'queryKey'> & { queryKey?: UseQueryOptions<FetchingTestingQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useQuery<FetchingTestingQuery, TError, TData>(
      {
    queryKey: variables === undefined ? ['fetchingTesting'] : ['fetchingTesting', variables],
    queryFn: fetcher<FetchingTestingQuery, FetchingTestingQueryVariables>(FetchingTestingDocument, variables),
    ...options
  }
    )};

useFetchingTestingQuery.getKey = (variables?: FetchingTestingQueryVariables) => variables === undefined ? ['fetchingTesting'] : ['fetchingTesting', variables];

export const useSuspenseFetchingTestingQuery = <
      TData = FetchingTestingQuery,
      TError = unknown
    >(
      variables?: FetchingTestingQueryVariables,
      options?: Omit<UseSuspenseQueryOptions<FetchingTestingQuery, TError, TData>, 'queryKey'> & { queryKey?: UseSuspenseQueryOptions<FetchingTestingQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useSuspenseQuery<FetchingTestingQuery, TError, TData>(
      {
    queryKey: variables === undefined ? ['fetchingTestingSuspense'] : ['fetchingTestingSuspense', variables],
    queryFn: fetcher<FetchingTestingQuery, FetchingTestingQueryVariables>(FetchingTestingDocument, variables),
    ...options
  }
    )};

useSuspenseFetchingTestingQuery.getKey = (variables?: FetchingTestingQueryVariables) => variables === undefined ? ['fetchingTestingSuspense'] : ['fetchingTestingSuspense', variables];

export const useInfiniteFetchingTestingQuery = <
      TData = InfiniteData<FetchingTestingQuery>,
      TError = unknown
    >(
      variables: FetchingTestingQueryVariables,
      options: Omit<UseInfiniteQueryOptions<FetchingTestingQuery, TError, TData>, 'queryKey'> & { queryKey?: UseInfiniteQueryOptions<FetchingTestingQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useInfiniteQuery<FetchingTestingQuery, TError, TData>(
      (() => {
    const { queryKey: optionsQueryKey, ...restOptions } = options;
    return {
      queryKey: optionsQueryKey ?? variables === undefined ? ['fetchingTesting.infinite'] : ['fetchingTesting.infinite', variables],
      queryFn: (metaData) => fetcher<FetchingTestingQuery, FetchingTestingQueryVariables>(FetchingTestingDocument, {...variables, ...(metaData.pageParam ?? {})})(),
      ...restOptions
    }
  })()
    )};

useInfiniteFetchingTestingQuery.getKey = (variables?: FetchingTestingQueryVariables) => variables === undefined ? ['fetchingTesting.infinite'] : ['fetchingTesting.infinite', variables];

export const useSuspenseInfiniteFetchingTestingQuery = <
      TData = InfiniteData<FetchingTestingQuery>,
      TError = unknown
    >(
      variables: FetchingTestingQueryVariables,
      options: Omit<UseSuspenseInfiniteQueryOptions<FetchingTestingQuery, TError, TData>, 'queryKey'> & { queryKey?: UseSuspenseInfiniteQueryOptions<FetchingTestingQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useSuspenseInfiniteQuery<FetchingTestingQuery, TError, TData>(
      (() => {
    const { queryKey: optionsQueryKey, ...restOptions } = options;
    return {
      queryKey: optionsQueryKey ?? variables === undefined ? ['fetchingTesting.infiniteSuspense'] : ['fetchingTesting.infiniteSuspense', variables],
      queryFn: (metaData) => fetcher<FetchingTestingQuery, FetchingTestingQueryVariables>(FetchingTestingDocument, {...variables, ...(metaData.pageParam ?? {})})(),
      ...restOptions
    }
  })()
...
useSuspenseInfiniteFetchingTestingQuery.getKey = (variables?: FetchingTestingQueryVariables) => variables === undefined ? ['fetchingTesting.infiniteSuspense'] : ['fetchingTesting.infiniteSuspense', variables];


useFetchingTestingQuery.fetcher = (variables?: FetchingTestingQueryVariables, options?: RequestInit['headers']) => fetcher<FetchingTestingQuery, FetchingTestingQueryVariables>(FetchingTestingDocument, variables, options);
