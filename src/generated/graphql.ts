...
export const useSaveFormMutation = <
      TError = unknown,
      TContext = unknown
    >(options?: UseMutationOptions<SaveFormMutation, TError, SaveFormMutationVariables, TContext>) => {
    
    return useMutation<SaveFormMutation, TError, SaveFormMutationVariables, TContext>(
      {
    mutationKey: ['saveForm'],
    mutationFn: (variables?: SaveFormMutationVariables) => fetcher<SaveFormMutation, SaveFormMutationVariables>(SaveFormDocument, variables)(),
    ...options
  }
    )};


useSaveFormMutation.fetcher = (variables: SaveFormMutationVariables, options?: RequestInit['headers']) => fetcher<SaveFormMutation, SaveFormMutationVariables>(SaveFormDocument, variables, options);
