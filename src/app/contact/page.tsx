  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const result = await emailjs.send(
        process.env.NEXT_PUBLIC_EMAILJS_SERVICE_ID || 'service_your_service_id', // Replace with your EmailJS service ID
        process.env.NEXT_PUBLIC_EMAILJS_TEMPLATE_ID || 'template_your_template_id', // Replace with your EmailJS template ID
        {
        ...
        process.env.NEXT_PUBLIC_EMAILJS_PUBLIC_KEY || 'your_public_key' // Replace with your EmailJS public key
      );
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="Reservation Inquiry" className="text-gray-900">Reservation Inquiry</option>
                    <option value="General Information" className="text-gray-900">General Information</option>
                    <option value="Event Planning" className="text-gray-900">Event Planning</option>
