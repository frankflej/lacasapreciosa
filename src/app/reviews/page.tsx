          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                >
                  <option value="" className="text-gray-500">Select experience type</option>
                  <option value="Accommodation" className="text-gray-900">Accommodation</option>
                  <option value="Dining" className="text-gray-900">Dining</option>
                  <option value="Cave Dancing" className="text-gray-900">Cave Dancing</option>
                  <option value="Boat Tours" className="text-gray-900">Boat Tours</option>
                  <option value="Outdoor Lounge" className="text-gray-900">Outdoor Lounge</option>
                  <option value="Lakeside Fire Pit" className="text-gray-900">Lakeside Fire Pit</option>
                  <option value="Overall Experience" className="text-gray-900">Overall Experience</option>
                </select>
              </div>
              <div>
