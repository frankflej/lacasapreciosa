...
export default function Footer () {
    ...
    const footerNavs = [
        ...
        },
        {
            ...
            items: [
                {
                    href: 'https://www.instagram.com/negra_hotel/',
                    name: 'Instagram'
                },
                {
                    href: 'https://www.facebook.com/negrahotel/',
                    name: 'Facebook'
                },
                {
                    href: 'https://www.tiktok.com/@negrahotel',
                    name: 'TikTok'
                },
                {
                    href: 'https://www.youtube.com/@negrahotel',
                    name: 'Youtube'
                },
            ],
        },
        {
            ...
            items: [
                {
                    href: 'https://www.google.com/maps/place/Negra+Hotel+%26+Spa/@26.270692,73.009036,17z/data=!3m1!4b1!4m6!3m5!1s0x3744ff9b1f777b8f:0x828d43bfe280680!8m2!3d26.270692!4d73.0112247!16s%2Fg%2F11c48xq000',
                    name: 'Google Maps'
                },
            ]
        }
    ...
    return (
        <footer className="text-gray-500 bg-white px-4 py-5 max-w-screen-xl mx-auto md:px-8">
            <div className="gap-[14rem] justify-between md:flex">
                <div className="">
                    <div className="max-w-xs">
                        <Image src={negra} alt='negra' className='w-[12rem] h-[12rem]' />
                    ...
                    >
                        ...
                        <div className="max-w-sm flex items-center border rounded-md p-1">
                            <input 
                                ...
                                className="w-full p-2.5 outline-none"
                            />
                            <BorderMagic buttonDetail='Subscribe' className='bg-black text-white' />
                        </div>
                    </form>
                                                    </div>
                                                )
